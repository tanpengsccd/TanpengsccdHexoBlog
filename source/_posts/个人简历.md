...
- 开发周期  
    2015.11-2015.11
- 软件描述
    - 开源地址：http://git.oschina.net/tanpengsccd/CPU-Utiiity 
    - 完全自己设计开发的APP
...
- 开发周期  
    2016.8-至今
- 软件描述  
    - 开源地址：https://github.com/tanpengsccd/UPImageMacApp
...
## IT 技能（其它）
- 熟悉计算机组装与维护。自己的电脑从不找外人维护软硬件。
- 基本掌握PC电脑安装Mac系统步骤（俗称黑苹果）。本人开发学习的Mac电脑均为自己组装和安装。
- 初步掌握部署VPS服务器。为学习后台开发做铺垫。现在拥有1个bandwagon,N个CloudAtCost部署配额。
- 拥有多个自己VPS搭建的轻量级VPN（shadowsocks），资料查询（Google），技术交流（StackOverFlow ，bitbucket等）无障碍
...
## 职业规划
- 目标是全栈工程师和架构师
- 大概计划学习路线 H5(网页，微信小程序) --> Swift（iOS，Mac） --> PHP（MySQL，CentOS） 
